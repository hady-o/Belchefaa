...
namespace Belchfaa
{
    public partial class AboutUs : Form
    {
        ...
        {
            label1.Text = "\"Belshifa\" application has been developed by a team of 7 developers to provide users with a\r" +
                "flexible medicine ordering service. It allows users to search for the required medicine and \r" +
